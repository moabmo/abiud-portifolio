...
.navLink:hover{ background: rgba(255,255,255,0.07); border-color: rgba(255,255,255,0.12); color: rgba(255,255,255,0.94); }
.navLink.active{ background: rgba(255,255,255,0.10); border-color: rgba(255,255,255,0.16); color: rgba(255,255,255,0.96); }
...
.lead{ margin: 0 0 14px; max-width: 68ch; color: rgba(255,255,255,0.76); line-height: 1.65; }
...
.chip{ padding: 8px 10px; border-radius: 999px; font-size: 12px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.14); color: rgba(255,255,255,0.80); }
...
/* Sections full width but readable width inside */
...
.grid2, .grid3{ width: min(1200px, 92vw); margin: 0 auto; display: grid; gap: 14px; }
...
.tag{ padding: 7px 10px; border-radius: 999px; font-size: 12px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.14); color: rgba(255,255,255,0.80); }

.subtleNote{ width: min(1200px, 92vw); margin: 12px auto 0; color: rgba(255,255,255,0.60); font-size: 13px; }

.contactCard{ width: min(1200px, 92vw); margin: 0 auto; display: flex; align-items: center; justify-content: space-between; gap: 14px; }
.contactRight{ display: flex; gap: 10px; flex-wrap: wrap; }

.footer{ width: min(1200px, 92vw); margin: 10px auto 0; padding: 18px 0 0; color: rgba(255,255,255,0.64); }
